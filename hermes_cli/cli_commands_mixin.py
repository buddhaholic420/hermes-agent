...
class CLICommandsMixin:
    ...
    def _handle_reasoning_command(self, cmd: str):
        ...
        Usage:
            ...
            /reasoning <level>      Set reasoning effort (none, minimal, low, medium, high, xhigh, ultra)
        ...
        if len(parts) < 2:
            ...
            _cprint(f"  {_DIM}Usage: /reasoning <none|minimal|low|medium|high|xhigh|ultra|show|hide|full|clamp>{_RST}")
            return
        ...
        if parsed is None:
            ...
            _cprint(f"  {_DIM}Valid levels: none, minimal, low, medium, high, xhigh, ultra{_RST}")
